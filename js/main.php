$(document).ready(function() {
    ...
    $('.generate-btn').on('click', function() {
        if ($('#ccUsername').val() != '') {
            ...
            sweetAlert("Error", "Please enter your RollerCoaster Tycoon Touch Username.", "error")
        }
    });

    function confirmDialogOpen(gems, gold, elixir, callback) {
        bootbox.dialog({
            message: "<p>Do you want to add the selected resources below to your RollerCoaster Tycoon Touch Account?</p><p><img src='img/coins.png' height='20px'/> " + gems + ".</p><p><img src='img/tickets.png' height='20px'/> " + gold + ".</p><p><img src='img/cards.png' height='20px'/> " + elixir + ".</p><p>Click Continue to get them now!</p>",
    ...
    function startConsoleAnimation(callback) {
        $('.generator-console').dynatexer({
            ...
            content: [{
                ...
                items: "open_ssl_connection tycoon_touch_hack_obsf -s 28.3.4.53.2 -deobfuscate -encrypt_aes_256"
            }, {
                delay: 200
            }, {
                animation: 'additive',
